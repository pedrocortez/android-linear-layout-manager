package br.com.xequemate.fidelidade.layoutManager;
 ...
 */
/**
 * Adapted by Pedro from LinearLayoutManager on 8/23/15.
 */
public class GridLayoutManager extends android.support.v7.widget.GridLayoutManager {
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        //
        final int numberOfLines = stateItemCount / spanCount;
        ...
        //I add this to when i get the size of childs that correspond the number of lines
        //in grid, we should stop increasing height
